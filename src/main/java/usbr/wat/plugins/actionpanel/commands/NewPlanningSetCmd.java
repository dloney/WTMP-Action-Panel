 ...
 *
 *
 * This command extends {@code AbstractNewPlanningSetCmd} to tailor creation for
 ...
 *
 */
public class NewPlanningSetCmd extends AbstractNewPlanningSetCmd {
	 ...
	 */
	public NewPlanningSetCmd(Project project, String name, String descr,
	 ...
	 *
	 * @return the file extension associated with {@link PlanningSet}
	 */
	@Override
	public String getExtension() {
		// Delegate to the planning group's static file extension constant
		return PlanningSet.FILE_EXT;
	}
	...
	public String getManagerClass() {
		...
		return PlanningSet.class.getName();
	}
