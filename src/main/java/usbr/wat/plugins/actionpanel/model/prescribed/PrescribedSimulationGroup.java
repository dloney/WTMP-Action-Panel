...
public class PrescribedSimulationGroup extends AbstractSimulationGroup {
	...
	/**
	 * Constructs an empty PrescribedSimulationGroup.
	 */
	public PrescribedSimulationGroup() {
		super();
	}
	 ...
	 *
	 * @return "PrescribedSimulationGroup"
	 */
	@Override
