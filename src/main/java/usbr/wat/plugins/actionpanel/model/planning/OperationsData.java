 ...
 * Planning boundary condition setup.
 *
 ...
 * operational forcing for one or more ensemble planning compute runs.
 *
 * It carries:
 ...
 *
 * Instances are loaded by PlanningSimulationGroup from the "Operations" XML element and
