 ...
 */
public class DeletePlanningSimGroupAction extends AbstractAction {
	/**
	...
	/**
	 * Creates the delete-planning-simulation-group action with a user-visible name.
	 *
	 ...
	 */
	public DeletePlanningSimGroupAction(BaseSimulationGroupPanel parentPanel, ActionsWindow parent) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		ActionPanelPlugin.getInstance().getActionsWindow().getPlanningPanel().loadSimulationGroupCombo();
