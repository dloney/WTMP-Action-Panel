...
public class EditEnsembleSetWindow extends RmaJDialog {
	 ...
	 *
	 * Iterates _esetsToDelete and calls ForecastSimulationGroup.deleteEnsembleSet for each,
	 * then iterates _esetsToAdd and calls ForecastSimulationGroup.addEnsembleSet for each.
	 *
	 ...
	 *
	 * @param simulationGroup the ForecastSimulationGroup whose BC data, temperature target sets,
	 ...
	 */
	public void fillForm(ForecastSimulationGroup simulationGroup, WatSimulation sim) {
